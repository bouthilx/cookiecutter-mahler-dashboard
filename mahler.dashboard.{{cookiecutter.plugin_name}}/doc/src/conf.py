# -*- coding: utf-8 -*-
#
# mahler.dashboard.{{ cookiecutter.plugin_name }} documentation build configuration file.
#
...
import mahler.dashboard.{{ cookiecutter.plugin_name }} as dashboard_plugin
...
project = u'mahler.dashboard.{{ cookiecutter.plugin_name }}'
_full_version = dashboard_plugin.__version__
copyright = dashboard_plugin.__copyright__
author = dashboard_plugin.__author__
...
latex_documents = [
  (master_doc, 'mahler.dashboard.{{ cookiecutter.plugin_name}}.tex',
   u'Mahler dashboard {{ cookiecutter.plugin_name }} Documentation',
...
texinfo_documents = [
  (master_doc, '{{ cookiecutter.plugin_name }}',
   u'Mahler dashboard {{ cookiecutter.plugin_name }} Documentation',
   author, '{{ cookiecutter.plugin_name }}', dashboard_plugin.__descr__,
   'Miscellaneous'),
]
